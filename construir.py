...
<section class="fondo-papel"><div class="wrap">
  <div class="prosa centrado">
    <img src="img/marca/marca-negro.png" alt="" style="height:96px;margin-bottom:26px;opacity:.9">
    <div class="et">El nombre</div>
    <h2 class="tit">Tres Tréboles</h2>
